...
class AchievementsScreen(
    ...
    private val achievements: List<Achievement> by lazy {
        ...
        listOf(
            Achievement("FIRST STEP", "Complete W1-L1", save.isUnlocked(1, 2)),
            Achievement("STAR SEEKER", "Earn 10 stars", total >= 10),
            Achievement("STAR HUNTER", "Earn 36 stars", total >= 36),
            Achievement("PERFECT", "Earn all $max stars", total >= max),
            ...
            Achievement("WORLD CLEAR", "Complete World 1", save.isUnlocked(2, 1)),
            Achievement("VOID WALKER", "Complete all 4 worlds", save.isUnlocked(4, 6))
        )
    }
    ...
    private fun hudMatrix() = camera.buildHudMatrix()
    ...
    override fun render() {
        ...
        bg.draw(batch, assets, hudMatrix())
        ...
        batch.end()
        tx.draw(batch, assets, sw, sh, hudMatrix())
    }
